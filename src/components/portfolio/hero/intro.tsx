...
export default function Intro() {
  return (
    <section className="relative h-screen w-full" id='intro'>
      <div className='absolute flex w-full h-full justify-center items-center'>

        <motion.div
          className="relative justify-center items-center z-10 w-11/12 "
          initial={{ opacity: 0, translateX:-100 }}
          animate={{ opacity: 1, translateX:0 }}
          transition={{ duration: 1 }}
        >
          <div className="w-full grid relative h-full grid-cols-1 gap-2">

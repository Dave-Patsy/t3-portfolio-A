'use client'
import { uploadSongFormSchema } from "@/schemas/spoty/upload"
...
export default function UploadSongForm() {
  ...
  const { mutate } = api.spoty.spotyUploadRouter.uploadSong.useMutation({
    async onMutate(variables) {
      await utils.spoty.spotySongRouter.getSongs.cancel();
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      //@ts-ignore
      const prevSongs: Songs = utils.spoty.spotySongRouter.getSongs.getData();
      const newSong: Songs = {
        userId: "",
      ...
      utils.spoty.spotySongRouter.getSongs.setData(
        undefined,
    ...
    onError(error, newPost, ctx) {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore
      utils.spoty.spotySongRouter.getSongs.setData(undefined, ctx!.prevSongs);
    ...
    async onSettled(){
      await utils.spoty.spotySongRouter.getSongs.invalidate()
    }
  });
